package com.pks.shoppingappadmin.allproduct
...
@Composable
fun AllProductScreen(modifier: Modifier = Modifier,nav:NavHostController,category:String,viewModel: CategoryViewModel) {
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Column(modifier = Modifier
            ...
            LazyColumn(modifier = Modifier.weight(1f)) {
                items(viewModel.statusList.value.filter {
